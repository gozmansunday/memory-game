  ...
  return (
    <section className="font-clash text-center font-semibold mt-24 xs:mt-40 sm:mt-48 md:mt-64 lg:mt-48">
      ...
      <button
        ...
        className="border-2 py-2 px-8 hover:bg-neutral-300 hover:text-neutral-900 transition duration-300 xs:border-[3px] sm:text-xl md:text-3xl md:border-4 md:py-3 md:px-12"
      >
        Play Again
      </button>
    </section>
